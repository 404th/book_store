...
var file_book_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x22, 0x1b, 0x0a, 0x09, 0x49, 0x44, 0x54, 0x72, 0x61, 0x63,
	0x6b, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x02, 0x69, 0x64, 0x32, 0xf4, 0x01, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6b, 0x53, 0x65, 0x72, 0x76,
	...
	0x69, 0x63, 0x65, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x22, 0x00, 0x42, 0x17, 0x5a, 0x15, 0x67, 0x65,
	0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x62, 0x6f, 0x6f, 0x6b, 0x5f, 0x73, 0x65, 0x72, 0x76,
...
var file_book_proto_goTypes = []interface{}{
	...
	(*IDTracker)(nil),           // 5: book_service.IDTracker
}
var file_book_proto_depIdxs = []int32{
	...
	5, // 4: book_service.BookService.CreateBook:output_type -> book_service.IDTracker
	3, // 5: book_service.BookService.GetAllBooks:output_type -> book_service.GetAllBooksResponse
	0, // 6: book_service.BookService.GetBookByID:output_type -> book_service.Book
